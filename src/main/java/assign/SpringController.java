...
import assign.Repo.PersonRepository;
import assign.Repo.SessionRepository;
import assign.Repo.UserRepository;
...
//@ComponentScan("assign.Repo")
//@ComponentScan("assign.Models")
@ComponentScan(basePackages = {"UserRepository"})
@EntityScan({"Models", "Repo"})
